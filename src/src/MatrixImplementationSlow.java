...
//        }
  ...
  @Override
  public List<long[][]> multiplyMatricesSlow(List<long[][]> generatedMatrices) {
    ...
    for (int i = 1; i < generatedMatrices.size(); i++) {
      ...
      result = multiplyTwoMatricesSlow(result, nextMatrix);
    }
  ...
  public List<long[][]> multiplyMatricesFast(List<long[][]> generatedMatrices) {
    ...
    for (int i = 1; i < generatedMatrices.size(); i++) {
      ...
      // Perform matrix multiplication (dot product)
      result = multiplyTwoMatricesFast(result, nextMatrix);
    }
